...
pub fn decode_context_data(
    ...
    ffi::decode_context_data(protocol_hash, key, data).map_err(|e| ContextDataError::DecodeError {
...
pub fn assert_encoding_for_protocol_data(
    ...
    ffi::assert_encoding_for_protocol_data(protocol_hash, protocol_data).map_err(|e| {
